...
# ─── WARP rotation planes (3 free WARP registrations = 3 distinct egress IPs) ─
...
# WARP rotation tiers — independent cadences cycling the 3 WARP planes.
...
PATH_ROTATE_WARP2MIN="/$(derive_hex path/rotatewarp2min 16)"
UUID_ROTATE_WARP2MIN=$(derive_uuid uuid/rotatewarp2min)
PATH_ROTATE_WARP4MIN="/$(derive_hex path/rotatewarp4min 16)"
UUID_ROTATE_WARP4MIN=$(derive_uuid uuid/rotatewarp4min)
PATH_ROTATE_WARP6MIN="/$(derive_hex path/rotatewarp6min 16)"
UUID_ROTATE_WARP6MIN=$(derive_uuid uuid/rotatewarp6min)
